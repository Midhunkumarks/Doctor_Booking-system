...
const navigate=useNavigate()
  ...
  return (
    <div>
       ...
       <div className='flex flex-col sm:flex-row items-start gap-5 mt-5 cursor-pointer'>
        ...
        <div className= {`flex flex-col gap-4 text-sm text-gray-600 ${showfilter ? 'flex' :'hidden sm:flex'}`}>
          ...
          <p onClick={()=>speciality==='Neutrologist' ? navigate('/doctors') : navigate('/doctors/Neutrologist') } className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer${speciality === "Neutrologist" ? "bg-indigo-100 text-black" : ""}`}>Neutrologist</p>
...
<div className="w-full grid grid-cols-[repeat(auto-fit,minmax(150px,1fr))] gap-4">
          ...
          <div onClick={()=>navigate(`/appointment/${items._id}`)}
            key={index}
