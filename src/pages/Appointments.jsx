...
setDocSlots([])
  ...
  for(let i=0;i<7;i++){
    ...
    while(currentDate < endTime){
      ...
      //Incement current time by 30 min
  ...
  return docInfo && (
    <div>
      ...
      <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
        ...
        <div>
           <p className='flex items-center gap-1 text-sm font-medium text-gray-900 mt-3'>About <img src={assets.info_icon} alt="nooo" /></p>
  ...
  slotIndex === index ? 'bg-blue-400 text-white' : 'border border-gray-200'
}`}
 key={index}>
